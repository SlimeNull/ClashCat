...
namespace ClashCat.Models.Clash.Configuration
{
    ...
    public class ClashDnsOptions
    {
        ...
        /// </summary>
        public List<string> DefaultNameserver { get; } = new List<string>();
        ...
        /// </summary>
        public List<string> Nameserver { get; } = new List<string>()
        {
            "114.114.114.114",
            "8.8.8.8",
        ...
        public ClashDnsFallbackFilterOptions FallbackFilter { get; } 
            = new ClashDnsFallbackFilterOptions();

        public Dictionary<string, string>? NameserverPolicy { get; set; }

        public List<ClashProxy> Proxies { get; } = new List<ClashProxy>();
    }
}